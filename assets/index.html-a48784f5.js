import{_ as d,S as l,n as r,p as o,q as e,C as i,A as c,J as n,a4 as a}from"./framework-69764084.js";const p="/images/php-windows-advanced-settings.png",u="/images/php-windows-environment-variables.png",m="/images/php-windows-add-path.png",h="/images/php-windows-add-path-2.png",v={},b=a('<h1 id="php" tabindex="-1"><a class="header-anchor" href="#php" aria-hidden="true">#</a> PHP</h1><p>Endless Lifecycle Support (ELS) for PHP from TuxCare provides security fixes for PHP versions that have reached their end-of-life. This allows you to continue running your server vulnerability-free.</p><h2 id="supported-os-and-php-versions" tabindex="-1"><a class="header-anchor" href="#supported-os-and-php-versions" aria-hidden="true">#</a> Supported OS and PHP versions</h2><p><strong>Supported architecture:</strong> 64-bit.</p><table><thead><tr><th style="text-align:center;">OS</th><th style="text-align:center;">Package Type</th><th style="text-align:center;">OS Version</th><th style="text-align:center;">PHP Version</th></tr></thead><tbody><tr><td style="text-align:center;">CentOS, CloudLinux, OracleLinux, etc.</td><td style="text-align:center;">RPM</td><td style="text-align:center;">6.x, 7.x, 8.x, 9.x</td><td style="text-align:center;">5.2, 5.3, 5.4, 5.5, 5.6, 7.0, 7.1, 7.2, 7.3, 7.4, 8.0, 8.1, 8.2, 8.3, 8.4</td></tr><tr><td style="text-align:center;">AlmaLinux</td><td style="text-align:center;">RPM</td><td style="text-align:center;">8.x, 9.x</td><td style="text-align:center;">5.2, 5.3, 5.4, 5.5, 5.6, 7.0, 7.1, 7.2, 7.3, 7.4, 8.0, 8.1, 8.2, 8.3, 8.4</td></tr><tr><td style="text-align:center;">Ubuntu</td><td style="text-align:center;">DEB</td><td style="text-align:center;">16.04, 18.04, 20.04, 22.04, 24.04</td><td style="text-align:center;">5.6, 7.0, 7.1, 7.2, 7.3, 7.4, 8.0, 8.1, 8.2, 8.3, 8.4</td></tr><tr><td style="text-align:center;">Debian</td><td style="text-align:center;">DEB</td><td style="text-align:center;">10, 11, 12</td><td style="text-align:center;">5.6, 7.0, 7.1, 7.2, 7.3, 7.4, 8.0, 8.1, 8.2, 8.3, 8.4</td></tr><tr><td style="text-align:center;">Windows</td><td style="text-align:center;">-</td><td style="text-align:center;">Windows Server 2019, 2022, 2025</td><td style="text-align:center;">5.6, 7.4</td></tr></tbody></table><p>Other distros and architectures upon request.</p><h2 id="vulnerability-coverage-and-target-response-times" tabindex="-1"><a class="header-anchor" href="#vulnerability-coverage-and-target-response-times" aria-hidden="true">#</a> Vulnerability Coverage and Target Response Times</h2><p>TuxCare employs the Common Vulnerability Scoring System (CVSS v3) to assess the severity of security vulnerabilities. Our severity rating system for patching vulnerabilities integrates both NVD scoring and vendor scoring (when available). When the vendor&#39;s score is lower than the NVD score, we prioritize the NVD score.</p><p>Aligning with many industry standards and regulatory requirements, TuxCare is committed to delivering timely security updates. For instance, the Payment Card Industry Data Security Standard (PCI-DSS) mandates that all &#39;High&#39; vulnerabilities (CVSS score of 7.0+) must be addressed within 30 days. Other regulations and standards, such as the Health Insurance Portability and Accountability Act (HIPAA) for healthcare or the Federal Information Security Management Act (FISMA) for government agencies, have similar requirements.</p><p>TuxCare will make commercially reasonable efforts to adhere to the following guidelines when addressing vulnerabilities:</p><ul><li><strong>High and Critical CVEs (CVSS 7+):</strong> Patches provided within 14 days</li><li><strong>Medium-severity CVEs (CVSS 4.0 to 6.9):</strong> Patches provided within 60 days</li><li><strong>Low-severity CVEs:</strong> Patches provided within 90 days</li><li>TuxCare may offer a mitigation strategy as an alternative to a direct code fix.</li></ul><h2 id="installation-instructions-for-linux" tabindex="-1"><a class="header-anchor" href="#installation-instructions-for-linux" aria-hidden="true">#</a> Installation Instructions for Linux</h2><h3 id="rpm-based-systems" tabindex="-1"><a class="header-anchor" href="#rpm-based-systems" aria-hidden="true">#</a> RPM-based Systems</h3><p>These steps are suitable for RPM-based systems (CentOS, CloudLinux, AlmaLinux, Oracle Linux, etc).</p>',14),g=e("p",null,"Download the installer script:",-1),x=e("div",{class:"language-text line-numbers-mode","data-ext":"text"},[e("pre",{class:"language-text"},[e("code",null,`wget https://repo.cloudlinux.com/php-els/install-php-els-rpm-repo.sh
`)]),e("div",{class:"line-numbers","aria-hidden":"true"},[e("div",{class:"line-number"})])],-1),f=e("p",null,"Run the installer script with keys. The installation script registers the server in the CLN with the key, adds the yum repository, and adds a PGP key to the server.",-1),y=e("div",{class:"language-text line-numbers-mode","data-ext":"text"},[e("pre",{class:"language-text"},[e("code",null,`sh install-php-els-rpm-repo.sh --license-key XXX-XXXXXXXXXXXX
`)]),e("div",{class:"line-numbers","aria-hidden":"true"},[e("div",{class:"line-number"})])],-1),P=e("li",null,[e("p",null,"Verify that the installation was successful."),e("p",null,[n("To ensure the installation has been completed successfully, run the following command. It should return info about a package. If information about the package is available it means that installation was successful. After which, updates will be available for installation from the repository using the usual "),e("code",null,"yum upgrade"),n(" command.")])],-1),w=a(`<p><strong>How to install packages:</strong></p><ul><li><p>Each version of PHP individually or all versions at once can be installed.</p></li><li><p>Standard commands to install each version separately can be used. For example, installing alt-php73:</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>yum install alt-php73*
...
post_max_size=40M
memory_limit=256M
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li></ul><h3 id="add-php-to-the-system-path" tabindex="-1"><a class="header-anchor" href="#add-php-to-the-system-path" aria-hidden="true">#</a> Add PHP to the System Path</h3><p>Adding PHP to the system PATH lets you run the <code>php</code> command from a terminal window without typing its full location. This is useful for running scripts and using PHP with other tools.</p><ul><li><p>Right-click <strong>This PC</strong> and select <strong>Properties</strong>, or search for <strong>Settings &gt; System &gt; About</strong> in the Start menu.</p></li><li><p>Click <strong>Advanced system settings</strong>.</p><p><img src="`+p+'" alt="image"></p></li><li><p>Click on <strong>Environment Variables</strong>.</p><p><img src="'+u+'" alt="image"></p></li><li><p>Under <em>System variables</em>, find <strong>Path</strong> and click <strong>Edit</strong>.</p><p><img src="'+m+'" alt="image"></p></li><li><p>Click <strong>New</strong> and add your PHP <code>C:\\PHP</code> directory.</p><p><img src="'+h+`" alt="image"></p></li><li><p>Click <strong>OK</strong> to save the changes.</p></li></ul><h3 id="validate-the-installation" tabindex="-1"><a class="header-anchor" href="#validate-the-installation" aria-hidden="true">#</a> Validate the Installation</h3><p>To confirm PHP is working:</p><ul><li><p>Open <strong>Command Prompt</strong>, <strong>PowerShell</strong>, or <strong>Terminal</strong>.</p></li><li><p>Run the following command:</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>php -v
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li></ul><h3 id="example-use-cases" tabindex="-1"><a class="header-anchor" href="#example-use-cases" aria-hidden="true">#</a> Example Use Cases</h3><p>You can integrate PHP with other tools, for example, IIS or WordPress. For further details and documentation, refer to the <a href="https://www.php.net/manual/en/index.php" target="_blank" rel="noopener noreferrer">official PHP documentation</a>.</p><h2 id="oval-data" tabindex="-1"><a class="header-anchor" href="#oval-data" aria-hidden="true">#</a> OVAL data</h2><h3 id="introduction" tabindex="-1"><a class="header-anchor" href="#introduction" aria-hidden="true">#</a> Introduction</h3><p>This section contains information about available ELS for PHP OVAL streams that can be used by vulnerability scanners.</p><p>Currently, we provide OVAL data for the following OS versions:</p><ul><li>EL 6 (CentOS, CloudLinux, OracleLinux, etc.)</li><li>EL 7 (CentOS, CloudLinux, OracleLinux, etc.)</li><li>EL 8 (AlmaLinux, CentOS, CloudLinux, OracleLinux, etc.)</li><li>EL 9 (AlmaLinux, CentOS, CloudLinux, etc.)</li><li>Ubuntu 16.04</li><li>Ubuntu 18.04</li><li>Ubuntu 20.04</li><li>Ubuntu 22.04</li><li>Debian 10</li><li>Debian 11</li><li>Debian 12</li></ul><h3 id="tuxcare-php-els-oval-streams" tabindex="-1"><a class="header-anchor" href="#tuxcare-php-els-oval-streams" aria-hidden="true">#</a> TuxCare PHP ELS OVAL Streams</h3><ul><li>EL 6: <a href="https://repo.cloudlinux.com/php-els/centos6-els-php-oval.xml" target="_blank" rel="noopener noreferrer">https://repo.cloudlinux.com/php-els/centos6-els-php-oval.xml</a></li><li>EL 7: <a href="https://repo.cloudlinux.com/php-els/centos7-els-php-oval.xml" target="_blank" rel="noopener noreferrer">https://repo.cloudlinux.com/php-els/centos7-els-php-oval.xml</a></li><li>EL 8: <a href="https://repo.cloudlinux.com/php-els/centos8-els-php-oval.xml" target="_blank" rel="noopener noreferrer">https://repo.cloudlinux.com/php-els/centos8-els-php-oval.xml</a></li><li>EL 9: <a href="https://repo.cloudlinux.com/php-els/centos9-els-php-oval.xml" target="_blank" rel="noopener noreferrer">https://repo.cloudlinux.com/php-els/centos9-els-php-oval.xml</a></li><li>Ubuntu 16.04: <a href="https://repo.cloudlinux.com/php-els/ubuntu16.04-els-php-oval.xml" target="_blank" rel="noopener noreferrer">https://repo.cloudlinux.com/php-els/ubuntu16.04-els-php-oval.xml</a></li><li>Ubuntu 18.04: <a href="https://repo.cloudlinux.com/php-els/ubuntu18.04-els-php-oval.xml" target="_blank" rel="noopener noreferrer">https://repo.cloudlinux.com/php-els/ubuntu18.04-els-php-oval.xml</a></li><li>Ubuntu 20.04: <a href="https://repo.cloudlinux.com/php-els/ubuntu20.04-els-php-oval.xml" target="_blank" rel="noopener noreferrer">https://repo.cloudlinux.com/php-els/ubuntu20.04-els-php-oval.xml</a></li><li>Ubuntu 22.04: <a href="https://repo.cloudlinux.com/php-els/ubuntu22.04-els-php-oval.xml" target="_blank" rel="noopener noreferrer">https://repo.cloudlinux.com/php-els/ubuntu22.04-els-php-oval.xml</a></li><li>Debian 10: <a href="https://repo.cloudlinux.com/php-els/debian10-els-php-oval.xml" target="_blank" rel="noopener noreferrer">https://repo.cloudlinux.com/php-els/debian10-els-php-oval.xml</a></li><li>Debian 11: <a href="https://repo.cloudlinux.com/php-els/debian11-els-php-oval.xml" target="_blank" rel="noopener noreferrer">https://repo.cloudlinux.com/php-els/debian11-els-php-oval.xml</a></li><li>Debian 12: <a href="https://repo.cloudlinux.com/php-els/debian12-els-php-oval.xml" target="_blank" rel="noopener noreferrer">https://repo.cloudlinux.com/php-els/debian12-els-php-oval.xml</a></li></ul><h3 id="how-to-use-oval" tabindex="-1"><a class="header-anchor" href="#how-to-use-oval" aria-hidden="true">#</a> How to use OVAL</h3><ol><li><p>Install OpenSCAP</p><ul><li>for rpm systems:</li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>yum install openscap openscap-utils scap-security-guide -y
...
zlib
[Zend Modules]
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>As you can see, each version is entirely self-contained, and changing configurations in one will not impact the others, a desired feature in hosting environments.</p>`,64);function _(S,k){const t=l("CodeWithCopy"),s=l("CodeTabs");return r(),o("div",null,[b,e("ol",null,[e("li",null,[g,i(t,null,{default:c(()=>[x]),_:1})]),e("li",null,[f,y,n(),i(s,{tabs:[{title:"rpm",content:"sh install-php-els-rpm-repo.sh --license-key XXX-XXXXXXXXXXXX"},{title:"deb",content:"bash install-php-els-deb-repo.sh --license-key XXX-XXXXXXXXXXXX"}]},null,8,["tabs"])]),P]),i(s,{tabs:[{title:"rpm",content:`yum info alt-php73
...
Description : PHP is an HTML-embedded scripting language.`},{title:"deb",content:`apt-cache show alt-php73-cli
...
MD5sum: d6c664d4f4b229c1e6727804888f6079
Description: command-line interpreter for the PHP scripting language.
Description-md5: 0d83f7bf7177d3376a59b73890c8494d`}]},null,8,["tabs"]),w])}const C=d(v,[["render",_],["__file","index.html.vue"]]);export{C as default};
