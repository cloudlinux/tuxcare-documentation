...
post_max_size=40M
memory_limit=256M
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li></ul><h3 id="add-php-to-the-system-path" tabindex="-1"><a class="header-anchor" href="#add-php-to-the-system-path" aria-hidden="true">#</a> Add PHP to the System Path</h3><p>Adding PHP to the system PATH lets you run the <code>php</code> command from a terminal window without typing its full location. This is useful for running scripts and using PHP with other tools.</p><ul><li><p>Right-click <strong>This PC</strong> and select <strong>Properties</strong>, or search for <strong>Settings &gt; System &gt; About</strong> in the Start menu.</p></li><li><p>Click <strong>Advanced system settings</strong>.</p><p><img src="`+p+'" alt="image"></p></li><li><p>Click on <strong>Environment Variables</strong>.</p><p><img src="'+m+'" alt="image"></p></li><li><p>Under <em>System variables</em>, find <strong>Path</strong> and click <strong>Edit</strong>.</p><p><img src="'+h+'" alt="image"></p></li><li><p>Click <strong>New</strong> and add your PHP <code>C:\\PHP</code> directory.</p><p><img src="'+v+`" alt="image"></p></li><li><p>Click <strong>OK</strong> to save the changes.</p></li></ul><h3 id="validate-the-installation" tabindex="-1"><a class="header-anchor" href="#validate-the-installation" aria-hidden="true">#</a> Validate the Installation</h3><p>To confirm PHP is working:</p><ul><li><p>Open <strong>Command Prompt</strong>, <strong>PowerShell</strong>, or <strong>Terminal</strong>.</p></li><li><p>Run the following command:</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>php -v
...
zlib
[Zend Modules]
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>As you can see, each version is entirely self-contained, and changing configurations in one will not impact the others, a desired feature in hosting environments.</p>`,17);function k(X,C){const d=s("CodeWithCopy"),a=s("CodeTabs"),o=s("RouterLink");return c(),u("div",null,[g,e("ol",null,[e("li",null,[x,n(d,null,{default:t(()=>[f]),_:1})]),e("li",null,[y,P,i(),n(a,{tabs:[{title:"rpm",content:"sh install-php-els-rpm-repo.sh --license-key XXX-XXXXXXXXXXXX"},{title:"deb",content:"bash install-php-els-deb-repo.sh --license-key XXX-XXXXXXXXXXXX"}]},null,8,["tabs"])]),w]),n(a,{tabs:[{title:"rpm",content:`yum info alt-php73
...
MD5sum: d6c664d4f4b229c1e6727804888f6079
Description: command-line interpreter for the PHP scripting language.
Description-md5: 0d83f7bf7177d3376a59b73890c8494d`}]},null,8,["tabs"]),_,e("p",null,[i("You can find the list of the supported add-ons "),n(o,{to:"/cloudlinuxos/alt-ea_packages/#bundled-php-extensions"},{default:t(()=>[i("here")]),_:1}),i(".")]),S])}const L=r(b,[["render",k],["__file","index.html.vue"]]);export{L as default};
