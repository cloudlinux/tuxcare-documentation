import{_ as e,n as i,p as s,a6 as n}from"./framework-620c4f90.js";const a={},t=n(`<h1 id="eportal-api" tabindex="-1"><a class="header-anchor" href="#eportal-api" aria-hidden="true">#</a> ePortal API</h1><p>You may need to create a separate ePortal account for API usage with:</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>kc.eportal user -a api-user -p &lt;password&gt;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>This can be called during machine tear down to properly remove the server from ePortal.</p>`,173),r=[t];function d(o,l){return i(),s("div",null,r)}const c=e(a,[["render",d],["__file","index.html.vue"]]);export{c as default};
