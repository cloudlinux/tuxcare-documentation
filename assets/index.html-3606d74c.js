import{_ as t,n,p as a,a6 as l,v as i}from"./framework-a770bce2.js";const s={};function r(o,e){return n(),a("div",null,[e[0]||(e[0]=l(`<h1 id="python" tabindex="-1"><a class="header-anchor" href="#python" aria-hidden="true">#</a> Python</h1><p>Endless Lifecycle Support (ELS) for Python from TuxCare provides security fixes for Python versions that have reached their end-of-life. This allows you to continue running your server vulnerability-free.</p><h2 id="supported-os-and-python-versions" tabindex="-1"><a class="header-anchor" href="#supported-os-and-python-versions" aria-hidden="true">#</a> Supported OS and Python versions</h2><p><strong>Supported architecture:</strong> 64-bit.</p><table><thead><tr><th style="text-align:center;">Operating Systems</th><th style="text-align:center;">Package Type</th><th style="text-align:center;">OS Version</th></tr></thead><tbody><tr><td style="text-align:center;">EL 7 (CentOS, CloudLinux, Oracle Linux, etc.)</td><td style="text-align:center;">RPM</td><td style="text-align:center;">7.x</td></tr><tr><td style="text-align:center;">EL 8 (CentOS, CentOS Stream, CloudLinux, Oracle Linux, etc.)</td><td style="text-align:center;">RPM</td><td style="text-align:center;">8.x</td></tr><tr><td style="text-align:center;">EL 9 (AlmaLinux)</td><td style="text-align:center;">RPM</td><td style="text-align:center;">9.x</td></tr><tr><td style="text-align:center;">Ubuntu</td><td style="text-align:center;">DEB</td><td style="text-align:center;">16.04, 18.04, 20.04, 22.04, 24.04</td></tr><tr><td style="text-align:center;">Debian</td><td style="text-align:center;">DEB</td><td style="text-align:center;">10, 11, 12, 13</td></tr></tbody></table><p><strong>For supported Python versions, see <a href="https://cve.tuxcare.com/els-alt-python/projects" target="_blank" rel="noopener noreferrer">cve.tuxcare.com</a>.</strong></p><ul><li>Other distros and architectures upon request.</li></ul><h2 id="installation-instructions-for-linux" tabindex="-1"><a class="header-anchor" href="#installation-instructions-for-linux" aria-hidden="true">#</a> Installation Instructions for Linux</h2><h3 id="rpm-based" tabindex="-1"><a class="header-anchor" href="#rpm-based" aria-hidden="true">#</a> RPM-based</h3><p>These steps are suitable for RPM-based systems (CentOS, CloudLinux, AlmaLinux, Oracle Linux, etc).</p><ol><li>Download the installer script:</li></ol><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>wget https://repo.alt.tuxcare.com/alt-python-els/install-els-alt-python-rpm-repo.sh
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,30)),i(`
...
\`\`\`
`)])}const c=t(s,[["render",r],["__file","index.html.vue"]]);export{c as default};
