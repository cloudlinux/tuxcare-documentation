...
curl -kL -u &quot;\${EPORTAL_API_PASSWORD}&quot;&#39;:&#39;&quot;\${EPORTAL_API_PASSWORD}&quot; -X POST &quot;\${EPORTAL_URL}&quot;&#39;/admin/api/delete_server?ip=&#39;&quot;\${IP_TO_UNREGISTER}&quot;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="puppetのプラン" tabindex="-1"><a class="header-anchor" href="#puppetのプラン" aria-hidden="true">#</a> Puppetのプラン</h3><p>タスクではなくプランの作成をご希望の場合は、以下の手順でこのスクリプトから作成できます。</p><ul><li><code>eportal_puppet</code>という新しいディレクトリを作成します</li><li>このディレクトリ内に、以下のコマンドでboltプロジェクトを作成します<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>bolt project init
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="パッチセットの管理" tabindex="-1"><a class="header-anchor" href="#パッチセットの管理" aria-hidden="true">#</a> パッチセットの管理</h2><p><strong>POST /admin/api/patchsets/manage</strong></p><p>パッチセットでデプロイアクションの実行を許可します。</p><p>書き込み権限が必要で、Basic認証を受け入れます。</p><p><strong>クエリ文字列パラメータ：</strong></p><ul><li><code>patchset</code>：String（必須）。操作するパッチセットの名前。</li><li><code>feed</code>：String（必須）。操作するフィードの名前。複数回指定できます。</li><li><code>action</code>：String（必須）。実行する操作： <ul><li><code>enable</code>：指定したパッチセットを有効にします。</li><li><code>disable</code>：指定したパッチセットを無効にします。</li><li><code>enable-upto</code>：指定されたパッチセットまでの（より古い）すべてのパッチセットを有効にします。</li><li><code>undeploy-downto</code>：指定されたパッチセットまでの（より新しい）すべてのパッチセットをアンデプロイします。</li></ul></li><li><code>product</code>：String（オプション）。可能な値は、<code>kernel</code>、<code>user</code>、<code>qemu</code>、<code>db</code>です。指定された製品のパッチストアを選択します。デフォルトでは、kernelです。</li></ul><p><strong>応答：</strong></p><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code>{
  &quot;result&quot;: &quot;ok&quot;
}
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,141)]))}const o=i(a,[["render",l],["__file","index.html.vue"]]);export{o as default};
