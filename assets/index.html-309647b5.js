import{_ as d,S as s,n as p,p as u,a6 as n,q as t,J as r,C as a,A as c}from"./framework-a770bce2.js";const y=`<?xml version="1.0" encoding="UTF-8"?>
...
}`,b={__name:"index.html",setup(f){return(E,e)=>{const i=s("CodeTabs"),o=s("ResolvedCveTable"),l=s("ClientOnly");return p(),u("div",null,[e[6]||(e[6]=n('<h1 id="eclipse-jetty" tabindex="-1"><a class="header-anchor" href="#eclipse-jetty" aria-hidden="true">#</a> Eclipse Jetty</h1><p>TuxCare&#39;s Endless Lifecycle Support (ELS) for Eclipse Jetty provides security patches, and selected bug fixes, that are integral to the stable operation of applications running on Eclipse Jetty.</p><h2 id="supported-versions" tabindex="-1"><a class="header-anchor" href="#supported-versions" aria-hidden="true">#</a> Supported Versions</h2><ul><li>Eclipse Jetty 9.4.24.v20191120, 9.4.53.v20231009</li></ul><h2 id="connection-to-els-for-eclipse-jetty-repository" tabindex="-1"><a class="header-anchor" href="#connection-to-els-for-eclipse-jetty-repository" aria-hidden="true">#</a> Connection to ELS for Eclipse Jetty Repository</h2><p>This guide outlines the steps needed to integrate the TuxCare ELS for Eclipse Jetty repository into your Java application. The repository provides trusted Java libraries that can be easily integrated into your <strong>Maven</strong> and <strong>Gradle</strong> projects.</p><h3 id="step-1:-get-user-credentials" tabindex="-1"><a class="header-anchor" href="#step-1:-get-user-credentials" aria-hidden="true">#</a> Step 1: Get user credentials</h3><p>You need a username and password in order to use TuxCare ELS Eclipse Jetty repository. Anonymous access is disabled. To receive a username and password please contact <a href="mailto:sales@tuxcare.com">sales@tuxcare.com</a>.</p><h3 id="step-2:-configure-registry" tabindex="-1"><a class="header-anchor" href="#step-2:-configure-registry" aria-hidden="true">#</a> Step 2: Configure Registry</h3>',9)),t("ol",null,[e[3]||(e[3]=n(`<li><p>Navigate to the directory depending on your operating system.</p><ul><li>Windows</li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>Maven: C:\\Users\\{username}\\.m2
