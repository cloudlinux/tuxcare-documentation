...
`)]),e("div",{class:"line-numbers","aria-hidden":"true"},[e("div",{class:"line-number"}),e("div",{class:"line-number"}),e("div",{class:"line-number"})])],-1)])),_:1,__:[0]}),a[3]||(a[3]=e("div",{class:"warning custom-block"},[e("p",{class:"custom-block-title"}),e("p",null,[n("Replace ${TOKEN} with the token you received from "),e("a",{href:"mailto:sales@tuxcare.com"},"sales@tuxcare.com"),n(".")])],-1)),a[4]||(a[4]=e("ol",{start:"4"},[e("li",null,[n("Update your "),e("code",null,"package.json"),n(" file to replace your Angular dependencies with the TuxCare packages.")])],-1)),m(`  
  ...
  **Angular 19**
  ...
  `),a[5]||(a[5]=e("ol",{start:"5"},[e("li",null,"In your terminal, run the following command to install ELS for Angular:")],-1)),r(l,null,{default:o(()=>a[1]||(a[1]=[e("div",{class:"language-text line-numbers-mode","data-ext":"text"},[e("pre",{class:"language-text"},[e("code",null,`npm install --userconfig .npmrc
`)]),e("div",{class:"line-numbers","aria-hidden":"true"},[e("div",{class:"line-number"})])],-1)])),_:1,__:[1]}),a[6]||(a[6]=s(`<p>You will see an output like:</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>added 12 packages, removed 931 packages, changed 22 packages, and audited 57 packages in 23s

found 0 vulnerabilities
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ol start="6"><li>You&#39;ve successfully integrated the TuxCare ELS for Angular repository into your project.</li></ol>`,3))])}const j=i(p,[["render",g],["__file","index.html.vue"]]);export{j as default};
