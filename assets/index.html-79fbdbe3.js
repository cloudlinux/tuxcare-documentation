...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="#ovalデータ" tabindex="-1"><a class="header-anchor" href="##ovalデータ" aria-hidden="true">#</a> #OVALデータ</h2><h3 id="概要" tabindex="-1"><a class="header-anchor" href="#概要" aria-hidden="true">#</a> 概要</h3><p>この欄には、パートナーアプリケーションに統合するのに使用できるTuxCare ELS OVALストリームに関する情報が含まれています。</p><p>現在、以下の製品のOVALデータを提供しています。</p><ul><li>CentOS 6 ELS</li><li>Oracle Linux 6 ELS</li><li>CentOS 8 ELS</li><li>Ubuntu 16.04</li></ul><h3 id="tuxcare-els-ovalストリーム" tabindex="-1"><a class="header-anchor" href="#tuxcare-els-ovalストリーム" aria-hidden="true">#</a> TuxCare ELS OVALストリーム</h3><ul><li>CentOS 6: <a href="https://repo.cloudlinux.com/centos6-els/centos6-els-oval.xml" target="_blank" rel="noopener noreferrer">https://repo.cloudlinux.com/centos6-els/centos6-els-oval.xml</a></li><li>Oracle Linux 6: <a href="https://repo.cloudlinux.com/oraclelinux6-els/oraclelinux6-els-oval.xml" target="_blank" rel="noopener noreferrer">https://repo.cloudlinux.com/oraclelinux6-els/oraclelinux6-els-oval.xml</a></li><li>CentOS 8.4: <a href="https://repo.cloudlinux.com/centos8.4-els/centos84-els-oval.xml" target="_blank" rel="noopener noreferrer">https://repo.cloudlinux.com/centos8.4-els/centos84-els-oval.xml</a></li><li>CentOS 8.5: <a href="https://repo.cloudlinux.com/centos8.5-els/centos85-els-oval.xml" target="_blank" rel="noopener noreferrer">https://repo.cloudlinux.com/centos8.5-els/centos85-els-oval.xml</a></li><li>Ubuntu 16.04: <a href="https://repo.cloudlinux.com/ubuntu16_04-els/ubuntu16.04-els-oval.xml" target="_blank" rel="noopener noreferrer">https://repo.cloudlinux.com/ubuntu16_04-els/ubuntu16.04-els-oval.xml</a></li></ul><h3 id="elsでovalを使用する方法" tabindex="-1"><a class="header-anchor" href="#elsでovalを使用する方法" aria-hidden="true">#</a> ELSでOVALを使用する方法</h3><h4 id="centos-6、8、oracle-linux-6の場合" tabindex="-1"><a class="header-anchor" href="#centos-6、8、oracle-linux-6の場合" aria-hidden="true">#</a> CentOS 6、8、Oracle Linux 6の場合</h4><p>OVALを使用するには、システムがELSとして定義されていることを確認してください。</p><ol><li>以下のコマンドを実行します。</li></ol><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>$ rpm -qi els-define centos-els-release | grep -o &quot;8c55a6628608cb71&quot;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,122)]))}const c=l(s,[["render",d],["__file","index.html.vue"]]);export{c as default};
