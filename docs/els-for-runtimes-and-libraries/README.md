...
Endless Lifecycle Support for Runtimes & Libraries provides security fixes for language runtimes and software libraries beyond their official end-of-life date:
