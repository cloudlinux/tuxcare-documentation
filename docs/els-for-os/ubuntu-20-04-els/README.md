...
* Architecture: x86_64 (amd64), arm64, and i386. For other architectures, please contact our [sales@tuxcare.com](mailto:sales@tuxcare.com).
...
* ![](/images/shield-alert.webp) [OVAL](https://security.tuxcare.com/oval/els_os/ubuntu20.04els/oval.xml) — Open Vulnerability and Assessment Language (OVAL) security data
* ![](/images/unlock-alt.webp) [CSAF](https://security.tuxcare.com/csaf/v2/els_os/ubuntu20.04els/) — Common Security Advisory Framework (CSAF) security advisories
