...
Endless Lifecycle Support (ELS) for yii2-dev from TuxCare provides security fixes for Yii 2 framework versions that have reached their end-of-life. This allows you to continue running your applications without vulnerability concerns, even after official support has ended.
...
4. Install yii2-dev
   ...
   Install the TuxCare-maintained yii2-dev release that matches your project:

   <CodeTabs :tabs="[
     { title: 'Composer CLI', content: `composer require yiisoft/yii2-dev:2.0.54-p1+tuxcare` },
     { title: 'composer.json', content: yii2devjson }
   ]" />
...
* ![](/images/eye.webp) [CVE Tracker](https://tuxcare.com/cve-tracker/?q=yiisoft%2Fyii2-dev) — Track vulnerability fixes and updates
* ![](/images/bolt.webp) [Available fixes](https://tuxcare.com/cve-tracker/fixes?q=yiisoft%2Fyii2-dev) — Patched versions and changelogs
* ![](/images/shield-alert.webp) [VEX feed](https://security.tuxcare.com/vex/cyclonedx/els_lang_php/yiisoft/yii2-dev/) — Vulnerability Exploitability eXchange feed
...
`{
    "require": {
        "yiisoft/yii2-dev": "2.0.54-p1+tuxcare"
    }
}`
