...
Endless Lifecycle Support (ELS) for Thruway from TuxCare provides security fixes for the Thruway WAMP (Web Application Messaging Protocol) library versions that have reached their end-of-life. This allows you to continue running your applications without vulnerability concerns, even after official support has ended.
...
4. Install Thruway
   ...
   <CodeTabs :tabs="[
     ...
     { title: 'composer.json', content: thruwayjson }
   ]" />
