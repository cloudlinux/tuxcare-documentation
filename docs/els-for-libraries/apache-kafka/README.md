...
For example: [https://nexus.repo.tuxcare.com/repository/els_java/org/apache/kafka/kafka-clients/3.2.3.tuxcare.1/kafka-clients-3.2.3.tuxcare.1-sources.jar](https://nexus.repo.tuxcare.com/repository/els_java/org/apache/kafka/kafka-clients/3.2.3.tuxcare.1/kafka-clients-3.2.3.tuxcare.1-sources.jar).
