...
Endless Lifecycle Support (ELS) for Apigility from TuxCare provides security fixes for Apigility (an API builder for Zend Framework) versions that have reached their end of life. This allows you to continue running your applications without vulnerability concerns, even after official support has ended.
...
4. Install Apigility
   ...
   Install the TuxCare-maintained Apigility release that matches your project:

   <CodeTabs :tabs="[
     { title: 'Composer CLI', content: `composer require zfcampus/zf-apigility:1.2.1-p1+tuxcare` },
...
* ![](/images/eye.webp) [CVE Tracker](https://tuxcare.com/cve-tracker/?q=zfcampus%2Fzf-apigility) — Track vulnerability fixes and updates
* ![](/images/bolt.webp) [Available fixes](https://tuxcare.com/cve-tracker/fixes?q=zfcampus%2Fzf-apigility) — Patched versions and changelogs
* ![](/images/shield-alert.webp) [VEX feed](https://security.tuxcare.com/vex/cyclonedx/els_lang_php/zfcampus/zf-apigility/) — Vulnerability Exploitability eXchange feed
...
`{
    "require": {
        "zfcampus/zf-apigility": "1.2.1-p1+tuxcare"
    }
}`
