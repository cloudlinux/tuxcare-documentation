...
7. You've successfully installed the Tuxcare ELS version of the react-pdf library into your project.
...
* **Option 2: Manual Update via CLI (Single Dependency)**
  ...
  ```text
  npm install react-pdf@npm:@els-js/react-pdf@7.7.1-tuxcare.2
  ```
