...
Endless Lifecycle Support (ELS) for Assetic from TuxCare provides security fixes for Assetic (an asset management framework for PHP) versions that have reached their end of life. This allows you to continue running your applications without vulnerability concerns, even after official support has ended.
...
4. Install Assetic
   ...
   Install the TuxCare-maintained Assetic release that matches your project:

   <CodeTabs :tabs="[
     { title: 'Composer CLI', content: `composer require kriswallsmith/assetic:v1.4.0-p1+tuxcare` },
...
* ![](/images/eye.webp) [CVE Tracker](https://tuxcare.com/cve-tracker/?q=kriswallsmith%2Fassetic) — Track vulnerability fixes and updates
* ![](/images/bolt.webp) [Available fixes](https://tuxcare.com/cve-tracker/fixes?q=kriswallsmith%2Fassetic) — Patched versions and changelogs
* ![](/images/shield-alert.webp) [VEX feed](https://security.tuxcare.com/vex/cyclonedx/els_lang_php/kriswallsmith/assetic/) — Vulnerability Exploitability eXchange feed
...
`{
    "require": {
        "kriswallsmith/assetic": "v1.4.0-p1+tuxcare"
    }
}`
