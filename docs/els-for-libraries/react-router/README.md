...
7. You've successfully installed the Tuxcare ELS version of the react-router library into your project.
...
* **Option 2: Manual Update via CLI (Single Dependency)**
  ...
  ```text
  npm install react-router@npm:@els-js/react-router@7.5.1-tuxcare.2
  ```
